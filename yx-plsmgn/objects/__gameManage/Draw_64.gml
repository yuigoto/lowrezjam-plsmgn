...
if (surface_exists(messages)) {
    ...
    if (global.GAME_OVER) {
        ...
        drawTextOutlineExt(
            "GAME", 
            view_xport + view_wport / 2, 
            view_yport + view_hport / 2 - 20, 
            2, 
            2, 
            wave(-8, 8, .1, 0), 
            c_red, 
    ...
    // Create the surface
    messages = surface_create(cam_w, cam_h);
